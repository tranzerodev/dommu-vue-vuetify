  ...
  <div class="dashboard">
    ...
    >
      <template v-slot>
        ...
        <v-btn color="primary" to="/my-account/mortgage-cost-ratio"
          >Mortgage Health Indicator</v-btn
        >
    ...
    >
      <template v-slot>
        ...
        >
          <h3 id="dashboardGreeting">{{ reg.personalDetails.firstname }},</h3>
          <p>
  ...
  methods: {
    ...
    parseReportData() {
        ...
        for (var i = 0; i < series.length; i++) {
          ...
          if (
            ...
            for (var j = 0; j < fillInYears - 1; j++) {
              ...
              /*
              var currentGraphValuationAmount =
                parseInt(this.datacollection.datasets[2].data[graphIndex - 1]) +
                annualfillInValue;
                */
              // TODO get the above from a pre-built array  from getFillinPoints
      ...
      if (overridenValuation) {
        for (i = 0; i < graphSeries.length; i++) {
          /*
          // see if we need to skip some years to get to valuationAdjustmentDate
          if (
            this.reg.addressDetails.valuationAdjustmentDate &&
            valuationYear >= this.datacollection.labels[i]
          ) {
            //skip
          } else {
            this.datacollection.datasets[1].data[i] = TODO: calucalate this;
          }
         */
          ////////////////////////////////
          //
          // TODO get sam to model the maths
          //
          /////////////////////////////////////////
          this.datacollection.datasets[2].data[i] =
      ...
      //var equityStartValue = startValue - mortgageStartBalance;
      ...
      // TODO sort out directions when have real data to test on
    ...
    fitAverageRates(start, end, rates) {
      ...
      for (var j = 0; j < rates.length; j++) {
        totalRateChange = totalRateChange + rates[j];
        amountChanges[j] = rates[j] * amountChangePerPercent;
...
*/
    ...
    async getMortgageSearch() {
      ...
      var filter = {
        ...
        NumberOfSchemes: "20",
        Adverse: "false",
        DepositEquity: "" + this.registration.avmDetails.Valuation * 0.25,
        Capped: "false",
        Discounted: "true",
        Fixed: "true",
        Variable: "true",
        Tracker: "true",
        NewLTV: "75",
        NewLoanAmount: "" + this.registration.avmDetails.Valuation * 0.75,
        CurrentLoanAmount: "" + this.registration.avmDetails.Valuation * 0.75,
